...
class OceanDataModel(models.Model):
        riverName = models.CharField("河川名稱",max_length=10) #河川名稱
        ...
        distanceKM = models.TextField("距離流口距離（公里）",max_length=10,null=True) #距離流口距離（公里）
        ...
        stationModeBridge = models.CharField("採樣方式（船上）",max_length=10,null=True) #採樣方式（船上）
        ...
        class Meta:
            verbose_name="海洋測站基本資料"
            verbose_name_plural="海洋測站基本資料"    
#        def __str__(self):
#            return self.name
