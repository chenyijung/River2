...
#    print(df.loc[i,"stationName"],"\n")  #迴圈中逐項顯示資料
    ...
    df_export.loc[i,"inspectO2"]=df.loc[i,"inspectO2"]
    df_export.loc[i,"inspectBOD"]=df.loc[i,"inspectBOD"]
    df_export.loc[i,"inspectSS"]=df.loc[i,"inspectSS"]
    df_export.loc[i,"inspectN2"]=df.loc[i,"inspectN2"]
